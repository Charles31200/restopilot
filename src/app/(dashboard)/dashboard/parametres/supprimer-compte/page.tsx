  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="rounded-2xl border flex flex-col items-center gap-4 py-16 text-center"
        style={{ background: 'var(--rp-white)', borderColor: '#FEE2E2', boxShadow: 'var(--rp-shadow-card)' }}>
        ...
        <div>
          ...
          <p className="text-sm mt-1 max-w-xs" style={{ color: 'var(--rp-navy-muted)' }}>
            La suppression de compte sera disponible prochainement. Pour toute demande urgente,
            contactez-nous à{' '}
            <a href="mailto:charles.lecussan@gmail.com" className="text-red-600 hover:underline">
