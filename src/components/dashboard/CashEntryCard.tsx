        ...
        <>
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={saving}
              className="flex-1 py-2.5 text-[13px] font-medium rounded-[10px] transition-colors hover:bg-gray-50"
              style={{ color: '#888888', border: '1px solid #E5E5E5' }}
            >
              Annuler
            </button>
            <button
              ...
              style={{ background: '#000000', fontFamily: 'var(--font-display)' }}
            >
